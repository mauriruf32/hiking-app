...
const { login, register, logout, profile, verifyToken, profileHikingPlaces, createComment, getComments, hikingPlaceComment } = require ("../controllers/auth.controller.js");
